  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
      ...
      {paragraphs.map((paragraph, index) => (
        <div key={index} className="md:col-span-2 bg-card border border-border rounded-3xl p-6 transition-all hover:-translate-y-0.5 hover:border-muted hover:shadow-lg">
      ...
      <div className="md:row-span-2 bg-card border border-border rounded-3xl p-6 transition-all hover:-translate-y-0.5 hover:border-muted hover:shadow-lg">
        <div className="flex items-center gap-3 mb-5">
          ...
          <p className="text-muted-foreground text-[0.8rem] font-semibold tracking-[0.06em] uppercase">Mobile Development</p>
        </div>
      ...
      <div className="bg-card border border-border rounded-3xl p-6 transition-all hover:-translate-y-0.5 hover:border-muted hover:shadow-lg">
        <div className="flex items-center gap-3 mb-5">
          <div className="flex items-center justify-center size-9 rounded-xl bg-primary/10 text-primary shrink-0">
            <Puzzle className="size-4" />
          </div>
          <p className="text-muted-foreground text-[0.8rem] font-semibold tracking-[0.06em] uppercase">Tools & Integration</p>
        </div>
        <div className="flex flex-wrap gap-2">
          {tech.map((item, idx) => (
      ...
      <div className="bg-card border border-border rounded-3xl p-6 transition-all hover:-translate-y-0.5 hover:border-muted hover:shadow-lg">
        <div className="flex items-center gap-3 mb-5">
          ...
          <p className="text-muted-foreground text-[0.8rem] font-semibold tracking-[0.06em] uppercase">Soft Skills</p>
        </div>
        <div className="flex flex-wrap gap-2">
